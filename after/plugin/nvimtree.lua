...
-- Custom mappings only in the tree window
...
vim.keymap.set("n", "<leader>tff", ":NvimTreeFindFile")
vim.keymap.set("n", "<leader>tc", ":NvimTreeCollapse")
vim.keymap.set("n", "<leader>tf", ":NvimTreeFocus")
vim.keymap.set("n", "<leader>tr", ":NvimTreeRefresh")
